...
# #     $ python app.py  -c saved/log/20240827_035641_Image_DeepFM/config.yaml  -m Image_DeepFM  --pred True  --ckpt 20240827_035641_Image_DeepFM_best.pt
# #     로 실행하면 됩니다.
# python app.py  -c saved/log/FM/config.yaml  -m FM  --pred True  --ckpt saved/checkpoint/FM_best.pt
